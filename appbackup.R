...
server <- function(input, output, session) {
  ...
  cleancounties <- cleancounty %>% count(county)
  cleanstates <- cleancounty %>% count(state)
  
  # cleancounty <- cleancounty %>% left_join(fit, by="cs")
  
  # Generate printable string showing last day of data ----
